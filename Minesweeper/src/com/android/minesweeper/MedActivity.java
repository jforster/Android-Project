...
/**
 * Inherits methods from EasyActivity.  Handles
 * medium game board size.
 * 
 * @author Ryan Iverson and Jeffrey Forster
 *
 */
public class MedActivity extends EasyActivity{
	 ...
	 * @override allows for correct game to be started on Play Again
	 */
	public void gameOver(String winOrLoss){
		
		AlertDialog.Builder alert = new AlertDialog.Builder(MedActivity.this);//Create end of game alert
		...
		database.addScore("med",correctMinesGotten, time);
...
//						EasyActivity.this.finish();
	...
	public String getHighscores(){
		String returnString = "";
		List<Score> allScores = database.getAllScores("med");
